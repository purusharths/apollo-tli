...
# Apollo Variables
apollo=sphere(pos=vector(6551e3,0,0),color=color.red,make_trail=True, trail_type='points', interval=10, retain=50)
...
apollo.trail=curve(pos=[apollo.pos],color=color.red, trail_type='points')
