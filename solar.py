...
sun = sphere(pos=vector(0,0,0), radius=696e6, color=color.yellow, mass=333000 * mE)
mercury = sphere(pos=vector(0,0,0.387 * dE), radius=696e6, color=color.blue, mass=0.0553 * mE)
venus = sphere(pos=vector(0,0,0.723 * dE), radius=696e6, color=color.cyan, mass=0.815 * mE)
earth = sphere(pos=vector(0,0,dE), radius=696e6, color=color.green, mass=mE)
mars = sphere(pos=vector(0,0,1.52 * dE), radius=696e6, color=color.red, mass=0.107 * mE)
